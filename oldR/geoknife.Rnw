...
setProcessInputs(gk) <- list('DATASET_ID'='ppt',
                             'DATASET_URI'='http://cida.usgs.gov/thredds/dodsC/prism',
                             'TIME_START'='1895-01-01T00:00:00Z',
                             'TIME_END'='1900-01-01T00:00:00Z',
                             'DELIMITER'='TAB')
...
cat(' Large complex requests take longer to process.\n')
